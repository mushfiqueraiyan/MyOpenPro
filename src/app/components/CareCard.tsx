  ...
  return (
    <div>
      <div
        ...
        className="rounded-xl cursor-pointer border-t-3 hover:border-t transform duration-300 ease-in transition border-[#2ad4ce] bg-[#f2fef836] p-4 shadow-md  hover:shadow-md"
      >
